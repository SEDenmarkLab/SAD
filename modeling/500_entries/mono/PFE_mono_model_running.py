...
# indvl_csv = ['500_entry_altered_temp_scaled_ddG_mono_desc_matrix_avg.csv']
# indvl_csv = ['500_entry_altered_temp_scaled_ddG_mono_avg_PFE_2.csv']
indvl_csv = ['500_entry_altered_temp_scaled_ddG_mono_avg_PFE_3.csv']
