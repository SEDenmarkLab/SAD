...
def model_to_choose(model_type='GBR',random_state=42,**kwargs):
    ...
    if model_type == 'GBR':
        ...
        '''
        #New Trisubstituted (Seeded split with random_state=10)
        _model_params = {'alpha': 0.3,
        'criterion': 'friedman_mse',
        'learning_rate': 0.67,
        'loss': 'absolute_error',
...
# indvl_csv = ['Step_8_Altered_Temp_Scaled_ddG_Mono_Only_Desc_Matrix_Avg.csv']
...
# indvl_csv = ['Step_8_Altered_Temp_Scaled_ddG_Tetra_Only_Desc_Matrix_Avg.csv']
...
title = r'GBR Model New Features Cis Di'
path_for_plot = './gbr_cis_di_current_opt_attempt'
##############
